        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              //     }
              //     if (value.length > 12) {
              //       return "Name should be maximum 12 Digits";
              //     }
              //     if (value.length < 3) {
              //       return "Name should be minimum 3 Digits";
              //     }
              //     return null;
              //   },
              //   onSaved: ((newValue) {
              //     setState(() {
              //       dataList.name = newValue!;
              //     });
              //   }),
              TextFormField(
                keyboardType: TextInputType.number,
